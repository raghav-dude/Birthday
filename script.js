document.addEventListener('DOMContentLoaded', () => {
    ...
    unfoldButton.addEventListener('click', () => {
        transitionToStep('stepgallery');
        initPhotoSlider(); // Initialize slider when entering the step
    });

    // --- Step 3.5: Photo Gallery Interactions ---
    const toCelebrationBtn = document.getElementById('toCelebrationBtn');
